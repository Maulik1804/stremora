...
router.get("/trending", cachePublicRead({ ttlSeconds: 60 }), getTrendingVideos);
router.get(
  "/search",
  [
    query("q")
...
router.post(
  ...
  [
    ...
    body("cloudinaryPublicId")
      .notEmpty()
      .withMessage("cloudinaryPublicId is required"),
...
router.post(
  "/upload/:uploadSessionId/finalize",
  verifyJWT,
  finalizeChunkedUpload,
);
...
// Feed (GET /)
router.get("/", cachePublicRead({ ttlSeconds: 30 }), getAllVideos);
