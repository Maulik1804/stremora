...
export const videoService = {
  ...
  getUploadSignature: (resourceType = "video") =>
    api.get("/videos/upload/signature", {
      params: { resourceType },
      timeout: 10000,
    }),
  ...
  // ── Collab video ────────────────────────────────────────────────────────────
  inviteCollaborator: (id, usernameOrEmail) =>
    api.post(`/videos/${id}/collab/invite`, { usernameOrEmail }),
  ...
  removeCollaborator: (id, userId) =>
    api.delete(`/videos/${id}/collab/${userId}`),
