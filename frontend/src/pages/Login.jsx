    ...
    >
      ...
      <motion.div variants={itemVariants} className="text-center mb-8">
        <motion.div
          ...
          className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-linear-to-br from-red-500/20 to-red-600/10 border border-red-500/20 mb-5"
        >
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex justify-end -mt-1">
          <Link
            to="/forgot-password"
            className="text-xs text-accent-blue hover:text-[#6bbfff] transition-colors"
          >
            Forgot password?
          </Link>
        </motion.div>
        ...
        <motion.div variants={itemVariants}>
          <Button
            ...
            className="w-full rounded-2xl mt-1 h-12 text-base font-semibold"
          >
            Sign in
          </Button>
        </motion.div>
      ...
      <motion.p
        variants={itemVariants}
        className="mt-5 text-center text-sm text-[#555]"
      >
        Don't have an account?{" "}
        <Link
          to="/register"
          className="text-accent-blue hover:text-[#6bbfff] font-medium transition-colors"
        >
          Create one free
        </Link>
      </motion.p>
