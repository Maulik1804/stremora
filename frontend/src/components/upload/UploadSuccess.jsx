...
import { CheckCircle, ExternalLink, UploadCloud, Users } from 'lucide-react';
import { Link } from 'react-router-dom';
import Button from '../ui/Button';
import VideoCollabModal from '../video/VideoCollabModal';
      ...
      <div className="flex flex-col items-center gap-8 py-12 text-center">
        ...
        >
          ...
          <p className="text-sm text-[#aaaaaa] max-w-sm">
            Your video is live. Want to add a collaborator?
          </p>
        </motion.div>
        ...
        >
          ...
          {video?._id && (
            <Button variant="secondary" onClick={() => setShowCollab(true)}>
              <Users size={15} />
              Invite collaborator
            </Button>
          )}
